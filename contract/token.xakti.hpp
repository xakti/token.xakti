...
class [[eosio::contract("token.xakti")]] token : public eosio::contract {
public:
    ...
    */
    ACTION issue( const eosio::name& to, const eosio::asset& quantity, const string& memo );
...
//     ACTION closesupply( const symbol_code symcode );
